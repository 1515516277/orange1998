...
<!-- 标题 -->
		...
		<div class="row">
			<div class="col-md-6 col-md-offset-6">
				...
				<input class="btn btn-default btn-danger" type="button" onclick="window.location.href='/admin/emplist'" value="admin">
				<input class="btn btn-default btn-danger" type="button" onclick="CustomRealm()" value="清除缓存">
				<input class="btn btn-default btn-danger" type="button" onclick="CustomRealmUser()" value="清除user缓存">
				<input class="btn btn-default btn-danger" type="button" onclick="window.location.href='/login/logout'" value="退出">
				<input class="btn btn-default btn-danger" type="button" onclick="window.location.href='/emp/t'" value="/emp/t">
				<input class="btn btn-default btn-danger" type="button" onclick="window.location.href='/UserController/onlineuser'" value="在线用户">
			</div>
		</div>
<!-- 显示表单 -->
		<div class="row">
